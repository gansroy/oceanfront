...
function pluginConfig(compact, extractCss) {
  const ret = [
    ...
    postcss({
      extract: extractCss ? 'of-colorscheme-editor.css' : false,
      inject: false,
...
if (targetFormats.es) {
  buildFormats.push({
    ...
    output: {
      format: 'esm',
      file: 'dist/of-colorscheme-editor.esm.js',
    },
...
if (targetFormats.iife) {
  buildFormats.push({
    ...
    output: {
      compact: true,
      file: 'dist/of-colorscheme-editor-browser.min.js',
      format: 'iife',
...
if (targetFormats.cjs) {
  buildFormats.push({
    ...
    output: {
      compact: true,
      format: 'cjs',
      file: 'dist/of-colorscheme-editor.cjs.js',
      exports: 'named',
      globals,
    },

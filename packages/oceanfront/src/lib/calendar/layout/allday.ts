...
import { CalendarAlldayEventPlacement, InternalEvent, Timestamp } from "../common"
...
export const layoutAllday = (events: InternalEvent[], interval: Timestamp[], busy: BusyInfo): CalendarAlldayEventPlacement[] => {
